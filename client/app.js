...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const staticTextsConfig = [
    {
      text: " للأستفسار اسم حسابي في التيك توك هو jifn",
      fontSize: "25px",
      top: "60%",
      left: "25%",
    },
    { text: "نص 2", fontSize: "0px", top: "85%", left: "40%" },
    { text: "نص 3", fontSize: "0px", top: "90%", left: "70%" },
  ];
  ...
  const linkTextsConfig = [
    { text: "اضغط هنا", fontSize: "25px", top: "67%", left: "44%" },
    { text: "رابط 2", fontSize: "0px", top: "85%", left: "60%" },
    { text: "رابط 3", fontSize: "0px", top: "90%", left: "80%" },
  ];
